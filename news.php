...
<body onload="candidato();">
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="user.php"><i class="fa fa-flag fa-fw"></i> User Profile</a>
                        </li>
						<li><a href="changePassword.php"><i class="fa fa-asterisk fa-fw"></i> Change Password</a>
                        </li>
                        <li class="divider"></li>
            ...
            <!-- /.navbar-static-side -->
    <div id="page-wrapper"style=" margin-right: 20px;margin-bottom: 20px; background-repeat: no-repeat;margin-top: 70px;border-radius: 25px; background-image: url('page.jpg')">
			<br/>
			<div class="container">
					<center>
					<br/>
